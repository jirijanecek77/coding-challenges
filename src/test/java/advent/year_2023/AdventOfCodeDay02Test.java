...
class AdventOfCodeDay02Test {
    ...
    public static final String DATA = "Game 1: 4 red, 5 blue, 9 green; 7 green, 7 blue, 3 red; 16 red, 7 blue, 3 green; 11 green, 11 blue, 6 red; 12 red, 14 blue\n" +
    ...
    @Test
    void countGames() {
        assertEquals(2795, AdventOfCodeDay02.countGames(DATA));
    }

    @Test
    void countPowerOfSets() {
        assertEquals(75561, AdventOfCodeDay02.countPowerOfSets(DATA));
    }
}