...
class AdventOfCodeDay03Test {
    ...
    @Test
    void sumAdjacentToSymbol() {
        assertEquals(529618, AdventOfCodeDay03.sumAdjacentToSymbol(DATA));
    }

    @Test
    void sumAdjacentToAstrixSymbol() {
        assertEquals(77509019, AdventOfCodeDay03.sumAdjacentToAstrixSymbol(DATA));
    }
}