...
import SsmlParser.Ssml.SSMLAttribute;
import SsmlParser.Ssml.SSMLElement;
import SsmlParser.Ssml.SSMLText;
...
import static SsmlParser.Ssml.parseSSML;
import static SsmlParser.Ssml.ssmlNodeToText;
...
public class SsmlTest {
    ...
    public void shouldParseTagNames() {
        ...
        assertEquals(
                new SSMLElement("speak", Collections.emptyList(), Collections.singletonList(new SSMLElement("p", Collections.emptyList(), Collections.emptyList()))),
